...
import pickle
import dill
from tensorflow.python.keras.layers import Dropout,GRU
...
with open('TokenizerDill.pkl', 'rb') as input:
...
def generate_caption(image_path_img, max_tokens=30):

    image = load_image(image_path_img, size=img_size)
